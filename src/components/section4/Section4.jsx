...
const data = [
    ...
    {
        item: 'Reading and Understanding English document',
...
const subData = [
    ...
    {
        item: 'Test, debug, and troubleshoot web applications to ensure functionality and quality',
...
const softData = [
    {
        item: 'Teamwork & Collaboration Abilities',
        path: <MicrosoftTeamsLogo size={window.innerWidth < 1080 ? 24 : 28} color="#9943fa" />,
        background: '#fff'
    },
    {
        item: 'Leadership Skills: Branch Secretary of 19TTH1 class for two consecutive years',
        path: <Crown size={window.innerWidth < 1080 ? 24 : 28} color="#fcff38" />,
        background: '#000000'
    },
    {
        item: 'Listen and Receive Information. Promote Punctuality',
        path: <ChatsCircle size={window.innerWidth < 1080 ? 24 : 28} color="#25ab00" />,
        background: '#cccccc'
    },
    {
        item: 'Adaptable and Resistant to Pressure',
